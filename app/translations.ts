...
export const TRANSLATIONS = {
  de: {
    ...
    hero: {
      ...
      line3: "IT &",
      line4: "Bau.",
      ctaOffer: "Kostenloses Erstgespräch",
      ...
      audienceBauItems: "Handel mit Baustoffen · Hausbetreuung",
      exploreProjects: "Referenzen ansehen",
    },
    stats: {
      years: 40,
    ...
    heroPills: {
      itTitle: "Schwerpunkt IT",
      itSub: "Webentwicklung · Grafikdesign · PC-Bau",
      bauTitle: "Schwerpunkt Bau",
      bauSub1: "Handel mit Baustoffen",
      bauSub2: "Hausbetreuung",
      eduTitle: "HTL IT Matura",
      eduSub: "Absolviert · HTL Krems · IT-Schwerpunkt",
    },
    wasWirAnders: {
      label: "Unser Ansatz",
      title: "Was wir",
    ...
    ueberUns: {
      ...
      body: "Als inhabergeführtes Unternehmen bieten wir direkten, persönlichen Service ohne Umwege. Boris Plesnicar (Inhaber) verantwortet IT und Digital: Beratung, PC-Bau, Web, Systeme und Grafikdesign – als HTL-IT-Matura-Absolvent (HTL Krems) mit fundierter technischer Ausbildung. Ing. Dietmar Plesnicar übernimmt die Rolle der Unterstützung beim Bau – mit Hausbetreuung, Baustoffen und handelsnahen Themen, gestützt auf über 40 Jahre Erfahrung im Bauwesen. Regional in Österreich, IT auch remote.",
    ...
    team: {
      ...
      borisEdu: "HTL IT Matura absolviert · HTL Krems",
      borisCredential: "HTL IT Matura Absolvent",
  ...
  en: {
    ...
    hero: {
      ...
      line3: "IT &",
      line4: "construction.",
      ctaOffer: "Free first consultation",
      ...
      audienceBauItems: "Building-materials trade · Property care",
      exploreProjects: "View references",
    },
    stats: {
      years: 40,
    ...
    heroPills: {
      itTitle: "Focus: IT",
      itSub: "Web development · Graphic design · PC builds",
      bauTitle: "Focus: Construction",
      bauSub1: "Building-materials trade",
      bauSub2: "Property care",
      eduTitle: "HTL IT Matura",
      eduSub: "Graduate · HTL Krems · IT focus",
    },
    wasWirAnders: {
      label: "Our approach",
      title: "What we do",
    ...
    ueberUns: {
      ...
      body: "As an owner-run business we offer direct, personal service with no runaround. Boris Plesnicar (owner) leads IT and digital: consulting, PC builds, web, systems and graphic design – as an HTL IT Matura graduate (HTL Krems) with a solid technical foundation. Ing. Dietmar Plesnicar provides construction support – property care, building materials and trade-related topics – drawing on over 40 years of experience in the industry. Based in Austria with remote IT options.",
    ...
    team: {
      ...
      borisEdu: "HTL IT Matura graduate · HTL Krems",
      borisCredential: "HTL IT Matura graduate",
